  ...
  <div class="main-content">
    ...
    <div v-if="!showFlag">
      <el-form :inline="true" :model="searchForm" class="form-content">
        <el-form-item label="在线练习">
          <el-input v-model="searchForm.papername" placeholder="在线练习名称" clearable></el-input>
        </el-form-item>
        <el-form-item label="练习题库">
          <el-input v-model="searchForm.questionname" placeholder="练习题库名称" clearable></el-input>
        </el-form-item>
        <el-form-item>
