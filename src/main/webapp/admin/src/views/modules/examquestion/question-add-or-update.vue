<template>
  <div>
    <el-form
      ...
      label-width="80px"
    >
      <el-form-item label="选择在线练习" prop="paperid">
        <el-select @change="onPaperChange" v-model="ruleForm.paperid" placeholder="选择在线练习">
          <el-option
      ...
      <el-form-item label="练习题库" prop="questionname">
        <el-input
          style="width:600px;"
          type="textarea"
          min="1"
...
export default {
  data() {
    ...
    return {
      ...
      rules: {
        paperid: [{ required: true, message: "请选择在线练习", trigger: "blur" }],
        questionname: [
          { required: true, message: "练习题库内容不能为空", trigger: "blur" }
        ],
        type: [{ required: true, message: "请选择练习题库类型", trigger: "blur" }],
