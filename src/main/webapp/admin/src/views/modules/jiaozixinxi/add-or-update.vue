<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="证书名称" prop="zhengshumingcheng">
          <el-input v-model="ruleForm.zhengshumingcheng" 
              placeholder="证书名称" clearable  :readonly="ro.zhengshumingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="证书名称" prop="zhengshumingcheng">
              <el-input v-model="ruleForm.zhengshumingcheng" 
                placeholder="证书名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="报考时间" prop="baokaoshijian">
          <el-input v-model="ruleForm.baokaoshijian" 
              placeholder="报考时间" clearable  :readonly="ro.baokaoshijian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="报考时间" prop="baokaoshijian">
              <el-input v-model="ruleForm.baokaoshijian" 
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="考试大纲" prop="kaoshidagang">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="考试大纲"
                  v-model="ruleForm.kaoshidagang" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.kaoshidagang" label="考试大纲" prop="kaoshidagang">
                    <span>{{ruleForm.kaoshidagang}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.kaoshididian = true;
          ...
          if(o=='kaoshidagang'){
            this.ruleForm.kaoshidagang = obj[o];
	    this.ro.kaoshidagang = true;
            continue;
          }
        }
      }
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `jiaozixinxi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.jiaozixinxiCrossAddOrUpdateFlag = false;
						 this.parent.search();
