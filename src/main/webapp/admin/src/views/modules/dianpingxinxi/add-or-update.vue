<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="点评时间" prop="dianpingshijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.dianpingshijian" 
                type="datetime"
                :readonly="ro.dianpingshijian"
                placeholder="点评时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.dianpingshijian" label="点评时间" prop="dianpingshijian">
              <el-input v-model="ruleForm.dianpingshijian" 
                placeholder="点评时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="点评内容" prop="dianpingneirong">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="点评内容"
                  v-model="ruleForm.dianpingneirong" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.dianpingneirong" label="点评内容" prop="dianpingneirong">
                    <span>{{ruleForm.dianpingneirong}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="意见" prop="yijian">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="意见"
                  v-model="ruleForm.yijian" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.yijian" label="意见" prop="yijian">
                    <span>{{ruleForm.yijian}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  created() {
	this.ruleForm.dianpingshijian = this.getCurDateTime()
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xingming = true;
          ...
          if(o=='dianpingneirong'){
            this.ruleForm.dianpingneirong = obj[o];
	    this.ro.dianpingneirong = true;
            continue;
          }
          if(o=='yijian'){
            this.ruleForm.yijian = obj[o];
	    this.ro.yijian = true;
            continue;
          }
          if(o=='dianpingshijian'){
            this.ruleForm.dianpingshijian = obj[o];
	    this.ro.dianpingshijian = true;
            continue;
          }
          if(o=='gonghao'){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `dianpingxinxi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.dianpingxinxiCrossAddOrUpdateFlag = false;
						 this.parent.search();
