<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="资料类型" prop="ziliaoleixing">
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'&& !ro.ziliaofujian" label="资料附件" prop="ziliaofujian">
          <file-upload
          tip="点击上传资料附件"
          action="file/upload"
          :limit="1"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.ziliaofujian" label="资料附件" prop="ziliaofujian">
            <el-button type="text" size="small" @click="download($base.url+ruleForm.ziliaofujian)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="资料介绍" prop="ziliaojieshao">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.ziliaojieshao" label="资料介绍" prop="ziliaojieshao">
                    <span>{{ruleForm.ziliaojieshao}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
