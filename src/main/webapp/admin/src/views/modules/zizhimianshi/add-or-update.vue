<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="讲解价格" prop="jiangjiejiage">
          <el-input v-model="ruleForm.jiangjiejiage" 
              placeholder="讲解价格" clearable  :readonly="ro.jiangjiejiage"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="讲解价格" prop="jiangjiejiage">
              <el-input v-model="ruleForm.jiangjiejiage" 
                placeholder="讲解价格" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="答辩问题" prop="dabianwenti">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.dabianwenti" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.dabianwenti" label="答辩问题" prop="dabianwenti">
                    <span v-html="ruleForm.dabianwenti"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xueyuan = true;
          ...
          if(o=='jiangjiejiage'){
            this.ruleForm.jiangjiejiage = obj[o];
	    this.ro.jiangjiejiage = true;
            continue;
          }
          if(o=='shipin'){
	    ...
	    this.ro.fujian = true;
          ...
          if(o=='dabianwenti'){
            this.ruleForm.dabianwenti = obj[o];
	    this.ro.dabianwenti = true;
            continue;
          }
          if(o=='fabushijian'){
	...
	this.ruleForm.dabianwenti = this.ruleForm.dabianwenti.replace(reg,'../../../ssmjobfi/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `zizhimianshi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.zizhimianshiCrossAddOrUpdateFlag = false;
						 this.parent.search();
