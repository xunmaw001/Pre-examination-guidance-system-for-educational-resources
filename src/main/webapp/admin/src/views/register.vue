  ...
  <div>
      ...
      <div class="login-form">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<!-- <div v-if="tableName=='jiaoshi'" class="input-group">
			   <div class="label">讲解价格</div>
			   <div class="input-container">
			     <input v-model="ruleForm.jiangjiejiage" class="input" type="text" placeholder="讲解价格">
			   </div>
			 </div> -->
			<el-form-item label="讲解价格" class="input" v-if="tableName=='jiaoshi'">
			  <el-input v-model="ruleForm.jiangjiejiage" autocomplete="off" placeholder="讲解价格"  />
			</el-form-item>
			<!-- <div v-if="tableName=='jiaoshi'" class="input-group">
...
export default {
  ...
  methods: {
	...
	var url=this.tableName+"/register";
      ...
      if(`jiaoshi` == this.tableName && this.ruleForm.jiangjiejiage&&(!this.$validate.isNumber(this.ruleForm.jiangjiejiage))){
        this.$message.error(`讲解价格应输入数字`);
        return
      }
